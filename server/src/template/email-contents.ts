export class EmailContents {
  static getTemplateForVerification(snugName: string, link: string): string {
    return `
<section>
  ...
  <div style="text-align: center; margin-top: 20px;">
    <form action="${link}" method="post">
      ...
      <button type="submit" style="border-radius: 5px; width:30%; height: 30px; display:inline-block">${snugName}(으)로 이동 </button>
     </form>
  </div>
</section>
`;
  ...
  static getTemplateForRegister(snugName: string, link: string): string {
    return `
<section >
    <div style="text-align: center;">
  <img style="display:inline-block;" src="https://user-images.githubusercontent.com/44811887/69315268-6e571b80-0c79-11ea-8e61-1ae63501d4a6.png"/>
