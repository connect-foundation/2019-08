...
describe("Test identifier-validator", () => {
  describe("isOutOfRangeChar() method", () => {
    ...
    test("page, size 모두 null 인 경우, take & skip 모두 default 값으로 설정되어야 한다", () => {
      const pageable = new Pageable({page: null, size: null});
